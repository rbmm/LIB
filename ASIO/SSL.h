...
public:
	...
	SECURITY_STATUS Acquire(_In_ ULONG fCredentialUse, 
		_In_opt_ PCCERT_CONTEXT pCertContext = 0, 
		_In_opt_ ULONG dwFlags = 0, 
		_In_opt_ ULONG grbitEnabledProtocols = 0,
		_In_opt_ HCERTSTORE hRootStore = 0);
};
