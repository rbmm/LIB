...
typedef struct _SAM_DOMAIN_DISPLAY_USER {
	ULONG      Index;
	ULONG      Rid;
...
} SAM_DOMAIN_DISPLAY_USER, *PSAM_DOMAIN_DISPLAY_USER;

typedef struct _SAM_DOMAIN_DISPLAY_MACHINE {
	ULONG      Index;
	ULONG      Rid;
	ULONG      AccountControl;
	UNICODE_STRING AccountName;
	UNICODE_STRING AdminComment;
} SAM_DOMAIN_DISPLAY_MACHINE, *PSAM_DOMAIN_DISPLAY_MACHINE;

typedef struct _SAM_DOMAIN_DISPLAY_GROUP {
	ULONG      Index;
	ULONG      Rid;
	ULONG      Attributes;
	UNICODE_STRING AccountName;
	UNICODE_STRING AdminComment;
} SAM_DOMAIN_DISPLAY_GROUP, *PSAM_DOMAIN_DISPLAY_GROUP;

typedef struct _SAM_DOMAIN_DISPLAY_OEM_USER {
	ULONG           Index;
	STRING              OemAccountName;
} SAM_DOMAIN_DISPLAY_OEM_USER, *PSAM_DOMAIN_DISPLAY_OEM_USER;

typedef struct _SAM_DOMAIN_DISPLAY_OEM_GROUP {
	ULONG           Index;
	STRING              OemAccountName;
} SAM_DOMAIN_DISPLAY_OEM_GROUP, *PSAM_DOMAIN_DISPLAY_OEM_GROUP;
...
NTSTATUS
NTAPI
SamLookupNamesInDomain2(IN SAM_HANDLE DomainHandle,
					   IN ULONG Count,
					   IN PUNICODE_STRING Names,
					   OUT PSID* Sids,
					   OUT PSID_NAME_USE *Use);
